 ...
 */
declare type Path = Array<string>;
...
declare namespace Render {
    ...
    /*
     * Renders an arc/semi-circle
     * @param {number} x The X position
     * @param {number} y The Y position
     * @param {number} radius_outer The maximum radius
     * @param {number} radius_inner The minimum radius
     * @param {number} start_angle The starting angle
     * @param {number} rotation_amount The rotation angle
     * @param {number} segments The amount of segments
     * @param {Array<number>} color The arc's color
     */
    function Arc(x: number, y: number, radius_outer: number, radius_inner: number, start_angle: number, rotation_amount: number, segments: number, color: Array<number>): void;
...
declare interface Event {
     ...
     */
    GetInt(field_name: string): number;
     ...
     */
    GetFloat(field_name: string): number;
...
//{ Cheat, World, DataFile, Convar, UserCMD, UI, Entity, Exploit, View, Event, Sound, Material, Ragebot, AntiAim, Input, Local, Trace, Render, Globals, GrenadePrediction, Autostop };
